...
**Descripción:** El sistema debe notificar al cliente cuando un material no esté disponible y ofrecer proveedores alternativos.  
...
## RF-007: INFORMES Y ESTADÍSTICAS

### RF-007.1: Generación de Informes para el Administrador

**Descripción:** El sistema debe generar informes de ventas, inventario y pedidos para el administrador.  
